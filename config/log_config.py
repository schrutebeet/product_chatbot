...
log_file_info = os.path.join(log_path, f'supermarkets_INFO_{current_datetime}.txt')
log_file_debug = os.path.join(log_path, f'supermarkets_DEBUG_{current_datetime}.txt')
